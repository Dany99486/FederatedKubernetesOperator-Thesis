...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "53187ab3.uc.pt",
	...
	if err := (&controller.FederatedOperatorConfigReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "FederatedOperatorConfig")
		os.Exit(1)
	}
	if err := (&controller.FederatedPlacementReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		PromAPI: promAPI,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "FederatedPlacement")
		os.Exit(1)
	}
